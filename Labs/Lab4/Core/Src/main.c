...
int main(void)
{
  ...
  /* USER CODE END 2 */
  int16_t start_time = timer_start();  // Start the timer

      // Perform some operations...

  int16_t elapsed_time = timer_stop(start_time);  // Stop the timer and get elapsed time
  // Use elapsed_time as needed
