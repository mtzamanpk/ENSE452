...
public:
    ...
    /** 
       ...
       \param position The position at which to insert the new element (0 to size()).
       \pre Position must be in the range [0, size()].
       \post Inserts the new element at the specified position.
    */
